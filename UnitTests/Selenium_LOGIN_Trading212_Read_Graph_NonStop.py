...
value_EMA = 50
tperiod = '10 minutes'
grph_div_start_point = 3  # division graph of starting point? ( value = 1.28 to infinity)
...
# main_collect_data(driver2, "USD/CHF", value_EMA, tperiod, grph_div_start_point, cont_or_stop)

for currency in ["GBP/USD", "EUR/USD", "USD/JPY", "USD/CHF"]:
