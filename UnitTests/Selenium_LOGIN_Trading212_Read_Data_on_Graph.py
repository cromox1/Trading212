...
def baca_graff(driver):
    ...
    chkelements = driver.find_elements_by_xpath(xp_tooltip)
...
for ele in elements_tooltip:
    ...
    print('TEXT = ', " // ".join(toolTip.text.split('\n')[0:3]))
